...
//ARRAY of OBJECTS created with the makeObject FUNCTION
const productsObj = [
  {
    name: "Nachos",
  ...
  },
  {
    ...
    description:
      "Homemade beef chili, jalapeños, homemade cheese sauce, salsa.",
    price: 13.95,
    category: "Appetizers",
  },
  {
  ...
  },
  {
    ...
    description:
      "Undecided between a poutine and a burger? Why not both stacked together?",
    price: 17.95,
    category: "Burgers",
  },
  {
    ...
    description:
      "Fried Onion rings, bacon, monterey jack, pickles and lettuce. This will take you to the moon!",
    price: 19.95,
    category: "Burgers",
  },
  {
    ...
    description:
      "Homemade beef chili, cheddar, tortilla chips. Not sure who Sammy was but he sure made a damn great burger!",
    price: 18.95,
    category: "Burgers",
  },
  {
    ...
    description:
      "Smoky BBQ sauce, bacon, blue cheese, caramelized onions. This is what love taste like",
    price: 20.95,
    category: "Burgers",
  },
  {
    ...
    description:
      "Bacon, mushrooms, caramelized onions, smoky BBQ sauce, cheddar and Monterey Jack. Also served without mushrooms for people with working taste buds",
    price: 20.95,
    category: "Burgers",
  },
  {
    ...
    description:
      "6 quarter-pound beef patties, bacon, 3 slices of Monterey Jack & cheddar because screw that diet!",
    price: 32.95,
    category: "Burgers",
  },
  {
    ...
    description:
      "Pulled pork, bacon, ham, Monterey Jack, smoky BBQ sauce. Try not to think of that adorable looney tunes Character while you eat this you psycho!",
    price: 20.95,
    category: "Burgers",
  },
  {
    ...
    description:
      "Crispy fried chicken, candied bacon, Monterey Jack cheese, maple mayonnaise. Served between two waffles. Your judgment means nothing to us.",
    price: 19.95,
    category: "Burgers",
  },
  {
    ...
    description:
      "The classic you know and love. Ask for extra cheese, we wont judge",
    price: 9.95,
    category: "Classics",
  },
  {
  ...
  },
  {
    ...
    picture: "./docs/Mac_Hotdog-mac.jpg",
    description:
      "Mac N Cheese topped with baked mozzarella. You know you want two of these",
    price: 11.95,
    category: "Classics",
  },
  {
    ...
    description:
      "Grilled chicken, mushrooms, green peppers, caramelized onions topped with aged Mozzarella (Legal age).",
    price: 15.95,
    category: "Classics",
  },
  {
    ...
    description:
      "Refreshing pale beer. Served in a coffee cup to anyone ordering before noon",
    price: 6.95,
    category: "Beverages",
  },
  {
...
///NOT SURE THIS WILL WORK AS THE ADD TO CART BUTTON MAY BE LINKED TO THE SAME PRODUCTS IF ALL GENERATED WITH ONE STATEMENT
